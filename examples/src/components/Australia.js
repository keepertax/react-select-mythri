...
var AustraliaField = createClass({
	displayName: 'AustraliaField',
	propTypes: {
		...
		return (
			<div className="section">
				<h3 className="section-heading">
					{this.props.label}{' '}
					<a href="https://github.com/JedWatson/react-select/tree/v1.x/examples/src/components/States.js">
						(Source)
					</a>
				</h3>
				<Select
